...
public class JerryMain extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jerry_main);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Jerry");

        layout = new ArrayList<>();
        messages = new Messages();

        //Set name in action bar
        messages.setCurrname("jerry");
